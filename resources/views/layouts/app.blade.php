...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        th { background: var(--accent-light); color: var(--primary); padding: 14px 16px; font-size: 13px; text-align: left; text-transform: uppercase; letter-spacing: 0.5px; }
        td { padding: 14px 16px; border-top: 1px solid var(--border); text-align: left; font-size: 14px; color: var(--text); }
    ...
    <header>
        <div class="header-inner">
            ...
            <a href="{{ route('dashboard') }}" class="header-logo">
                ...
                <span class="header-logo-text"> CardDiabet</span>
            </a>
